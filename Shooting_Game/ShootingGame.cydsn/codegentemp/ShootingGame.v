// ======================================================================
// ShootingGame.v generated from TopDesign.cysch
// 05/29/2025 at 07:57
...
module UART_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("2b734e16-2b6b-406b-b763-67a1c7b97b16/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    defparam UART_BT.HwTXEnSignal = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("e064f1e4-6eb1-4599-9118-75b8007bb241"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("abb8c02e-477c-4a24-9aa2-0b08be657e22"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Target_BTN_1_net;
	wire [0:0] tmpFB_0__Target_BTN_1_net;
	wire [0:0] tmpIO_0__Target_BTN_1_net;
	wire [0:0] tmpINTERRUPT_0__Target_BTN_1_net;
	electrical [0:0] tmpSIOVREF__Target_BTN_1_net;

	cy_psoc3_pins_v1_10
		#(.id("c9b2b0a8-aab3-4402-9e59-06cdef58f58c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_BTN_1
		 (.oe(tmpOE__Target_BTN_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_BTN_1_net[0:0]}),
		  .io({tmpIO_0__Target_BTN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_BTN_1_net),
		  .interrupt({tmpINTERRUPT_0__Target_BTN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_BTN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Target_LED_1_net;
	wire [0:0] tmpFB_0__Target_LED_1_net;
	wire [0:0] tmpIO_0__Target_LED_1_net;
	wire [0:0] tmpINTERRUPT_0__Target_LED_1_net;
	electrical [0:0] tmpSIOVREF__Target_LED_1_net;

	cy_psoc3_pins_v1_10
		#(.id("0cc29d5a-b109-40f0-9814-1f65cb447ebb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_LED_1
		 (.oe(tmpOE__Target_LED_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_LED_1_net[0:0]}),
		  .io({tmpIO_0__Target_LED_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_LED_1_net),
		  .interrupt({tmpINTERRUPT_0__Target_LED_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_LED_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Target_BTN_2_net;
	wire [0:0] tmpFB_0__Target_BTN_2_net;
	wire [0:0] tmpIO_0__Target_BTN_2_net;
	wire [0:0] tmpINTERRUPT_0__Target_BTN_2_net;
	electrical [0:0] tmpSIOVREF__Target_BTN_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d541adce-e503-4541-96a2-6670d7b1f2c6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_BTN_2
		 (.oe(tmpOE__Target_BTN_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_BTN_2_net[0:0]}),
		  .io({tmpIO_0__Target_BTN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_BTN_2_net),
		  .interrupt({tmpINTERRUPT_0__Target_BTN_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_BTN_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Target_LED_2_net;
	wire [0:0] tmpFB_0__Target_LED_2_net;
	wire [0:0] tmpIO_0__Target_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__Target_LED_2_net;
	electrical [0:0] tmpSIOVREF__Target_LED_2_net;

	cy_psoc3_pins_v1_10
		#(.id("f2eb313c-d542-4b65-8262-a8527db2ace7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_LED_2
		 (.oe(tmpOE__Target_LED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_LED_2_net[0:0]}),
		  .io({tmpIO_0__Target_LED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_LED_2_net),
		  .interrupt({tmpINTERRUPT_0__Target_LED_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Target_BTN_3_net;
	wire [0:0] tmpFB_0__Target_BTN_3_net;
	wire [0:0] tmpIO_0__Target_BTN_3_net;
	wire [0:0] tmpINTERRUPT_0__Target_BTN_3_net;
	electrical [0:0] tmpSIOVREF__Target_BTN_3_net;

	cy_psoc3_pins_v1_10
		#(.id("e8adea6b-5d15-48b3-932c-f3a3f3a29331"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_BTN_3
		 (.oe(tmpOE__Target_BTN_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_BTN_3_net[0:0]}),
		  .io({tmpIO_0__Target_BTN_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_BTN_3_net),
		  .interrupt({tmpINTERRUPT_0__Target_BTN_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_BTN_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Target_LED_3_net;
	wire [0:0] tmpFB_0__Target_LED_3_net;
	wire [0:0] tmpIO_0__Target_LED_3_net;
	wire [0:0] tmpINTERRUPT_0__Target_LED_3_net;
	electrical [0:0] tmpSIOVREF__Target_LED_3_net;

	cy_psoc3_pins_v1_10
		#(.id("e20485bf-ca93-4419-aa5d-19cc0da5a355"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Target_LED_3
		 (.oe(tmpOE__Target_LED_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Target_LED_3_net[0:0]}),
		  .io({tmpIO_0__Target_LED_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Target_LED_3_net),
		  .interrupt({tmpINTERRUPT_0__Target_LED_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Target_LED_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_2 One_Sec_Timer (
        ...
        .tc(Net_78),
        .trigger(1'b1));
    defparam One_Sec_Timer.CaptureCount = 2;
    defparam One_Sec_Timer.CaptureCounterEnabled = 0;
    defparam One_Sec_Timer.DeviceFamily = "PSoC5";
    defparam One_Sec_Timer.InterruptOnCapture = 0;
    defparam One_Sec_Timer.InterruptOnTC = 1;
    defparam One_Sec_Timer.Resolution = 16;
    defparam One_Sec_Timer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("61ee83d3-a8b1-45c3-92a4-02c577b2d919"),
    ...
    defparam Debounce_Timer.DeviceFamily = "PSoC5";
    defparam Debounce_Timer.InterruptOnCapture = 0;
    defparam Debounce_Timer.InterruptOnTC = 1;
    defparam Debounce_Timer.Resolution = 8;
    defparam Debounce_Timer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("b784103a-bf3a-44bb-b164-13f7fbbf26ec"),
		  .source_clock_id("CEF43CFB-0213-49b9-B980-2FFAB81C5B47"),
		  .divisor(3000),
		  .period("0"),
		  .is_direct(0),
